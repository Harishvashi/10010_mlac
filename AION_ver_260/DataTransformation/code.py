...
File generation time: 2023-01-16 12:20:39
'''
import os
...
def transformation(log):
    ...
    train_data, test_data = train_test_split(df,stratify=df[target_feature],train_size=config['train_ratio'])
    profilerObj = profiler(xtrain=train_data, target=target_feature, encode_target=True, config=config['profiler'],log=log)
