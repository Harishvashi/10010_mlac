...
IOFiles = {
    ...
    "log": "GaussianNB_MLBased_aion.log",
    "model": "GaussianNB_MLBased_model.pkl",
    "performance": "GaussianNB_MLBased_performance.json",
    "metaDataOutput": "GaussianNB_MLBased_modelMetaData.json"
}
...
def train(log):        
    ...
    #Training model
    log.info('Training GaussianNB for modelBased')
    features = selected_features['modelBased']            
    estimator = GaussianNB()            
    param = config['algorithms']['GaussianNB']
