...
model_name = 'LogisticRegression_MLBased'
...
IOFiles = {
    ...
    "log": "LogisticRegression_MLBased_aion.log",
    "model": "LogisticRegression_MLBased_model.pkl",
    "performance": "LogisticRegression_MLBased_performance.json",
    "metaDataOutput": "LogisticRegression_MLBased_modelMetaData.json"
}
...
def train(log):        
    ...
    #Training model
    log.info('Training LogisticRegression for modelBased')
    features = selected_features['modelBased']            
    estimator = LogisticRegression()            
    param = config['algorithms']['LogisticRegression']
